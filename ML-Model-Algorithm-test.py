...
########################################################################################################################
###	1.	LOAD CSV-FILES w/ PYTHON STANDARD LIBRARY
###		-----------------------------------------
...
###	   b) LOAD THE DATASET DIRECTLY FROM A URL
###		from numpy import loadtxt
...
#						d)-CLASSIFIER	K-NEAREST NEIGHOR:		(KNN) - CLASSIFIER
#								-----------------
...
#						d)-REGRESOR	K-NEAREST NEIGHOR:		(KNN) - REGRESSOR
#								-----------------
...
#						e)-CLASSIFIER	CLASSIFICATION & REGRESSION TREE:	(CART) - CLASSIFIER
#								--------------------------------
...
#						e)-REGRESSOR	CLASSIFICATION & REGRESSION TREE:	(CART) - REGRESSOR
#								--------------------------------
...
#						f)	GAUSSIAN NAIVE BAYES:		(GaussianNB)
#							--------------------
...
#						d)-CLASSIFIER	K-NEAREST NEIGHBOR:			(KNN) - CLASSIFIER
#								------------------
# Randomized for Algorithm Tuning
import numpy
from pandas import read_csv
...
#						d)-REGRESSOR	K-NEAREST NEIGHBOR:			(KNN) - REGRESSOR
#								------------------
# Randomized for Algorithm Tuning
import numpy
from pandas import read_csv
...
#						e)-CLASSIFIER	CLASSIFICATION & REGRESSION TREES:			(CART) - CLASSIFIER
#								---------------------------------
# Randomized for Algorithm Tuning
import numpy
from pandas import read_csv
...
#						e)-REGRESSOR	CLASSIFICATION & REGRESSION TREES:			(CART) - REGRESSOR
#								---------------------------------
# Randomized for Algorithm Tuning
import numpy
from pandas import read_csv
...
###	5.	FINALIZING ML-MODEL/ALGORITHM (Serialize, Save, Load):
#####################################################################

#			1.)	SERIALIZE >> SAVE >> LOAD:
#				-------------------------
#						
...
#						d)-CLASSIFIER	K-NEAREST NEIGHBORS:				(KNN) - CLASSIFIER
#								-------------------
...
#						d)-REGRESSOR	K-NEAREST NEIGHBORS:				(KNN) - REGRESSOR
#								-------------------
